...
class TrendFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val dataTrend = arrayListOf<ItemPost>(
            ...
            ItemPost(
                "https://california18.com/wp-content/uploads/2022/05/Taylor-Swift-receives-an-honorary-doctorate.jpg",
                "Taylor Swift",
        ...
        binding.recyclerviewTrend.layoutManager = LinearLayoutManager( view.context, RecyclerView.VERTICAL, false )
